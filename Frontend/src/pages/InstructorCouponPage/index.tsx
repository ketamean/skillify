...
const InstructorCouponPage: React.FC = () => {
    ...
    const fetchInstructorCoupons = async () => {
        ...
        try {
            ...
            const res = await axios.get<Coupon[]>(`http://localhost:3000/api/coupons/instructor/${instructorId}`);
            setCoupons(res.data);
        } catch (err) {
        ...
        <div className="min-h-screen bg-custom-white">
            ...
            <div className="max-w-6xl mx-auto px-6 py-10">
                ...
                {loading ? (
                    ...
                    <p className="text-gray-500 text-center">You haven't created any coupons yet.</p>
                ) : (
                    <div className="overflow-x-auto border rounded-lg shadow-sm">
                        <table className="w-full text-left text-sm border-collapse">
                            ...
                            <tbody>
                                {coupons.map((coupon) => (
                                    <tr key={coupon.id} className="border-t hover:bg-gray-50 transition-colors duration-150">
