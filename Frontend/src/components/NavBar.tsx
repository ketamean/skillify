        ...
        <>
            ...
            >
                ...
                ">
                    ...
                    >
                        <div className="min-w-8 h-8 justify-end items-center
                        ...
                        <UserMiniAvatar fname={props.user.fname} lname={props.user.lname} title="View basic settings" avatarUrl={props.user.avatarUrl? props.user.avatarUrl : undefined}/>
                    </div>
                </div>
            </nav>
            <SearchOverlay 
